        ...
        <div className="w-full glass-effect bg-gradient-to-b from-white/10 to-white/5 p-6 rounded-3xl shadow-[0_8px_32px_rgba(0,0,0,0.3)] border border-white/20 flex flex-col items-center relative overflow-hidden z-10">
          ...
          {!imagePreview ? (
            <button 
              ...
              className="w-full py-4 glass-button bg-primary-500/30 text-white border border-primary-500/50 rounded-xl font-medium hover:bg-primary-500/40 transition-all active:scale-[0.98] flex items-center justify-center gap-2 shadow-[0_0_20px_rgba(139,92,246,0.2)]"
            >
            ...
            <div className="flex gap-3 w-full">
              ...
              <button 
                ...
                disabled={scanning}
                className="flex-[2] py-4 glass-button bg-primary-500/30 border border-primary-500/50 text-white rounded-xl font-medium hover:bg-primary-500/40 transition-all active:scale-[0.98] disabled:opacity-50 shadow-[0_0_20px_rgba(139,92,246,0.3)]"
              >
          ...
          {/* Status Text animado */}
          {scanning && (
            <div className="absolute inset-0 bg-darkGray-100/80 backdrop-blur-md z-20 flex flex-col items-center justify-center p-6 rounded-3xl">
              <div className="w-12 h-12 border-4 border-primary-500/30 border-t-primary-500 rounded-full animate-spin mb-4" />
              <p className="text-sm font-inter text-primary-400 font-semibold text-center animate-pulse">
                {statusText}
              </p>
            </div>
          )}
